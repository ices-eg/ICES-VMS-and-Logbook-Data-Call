...
StartFieldCodeDatatypeCode ListMandatoryDescription1RecordTypechar(2)MRecordType field consists of a 2-character code,  which defines the record type and thus the layout of the data fields included on that record.2CountryCodechar(3)ISO_3166MISO 3166-1 alpha-3 codes. The flag country  of the vessel.3Yearchar(4)YearMYear4Monthint(2)MMonth5NoDistinctVesselsint(5)MNumber of distinct vessels6AnonymizedVesselIDnvarchar(500)MAnonymized vessel ID: Country code + 3 digits and semicolon separated.  For example: ESP001; ESP003;7C-squarenvarchar(15)M0.05x0.05 degree,  C-square reference XXXX:XXX:XXX:X8MetierL4char(25)GearTypeL4MMetier level 49MetierL5char(50)TargetAssemblageMMetier level 510MetierL6char(40)Metier6_FishingActivityMMetier level 611VesselLengthRangechar(20)VesselLengthClassMLength class for vessels used in data sampling12HabitatnvarcharHabitat type13DepthnvarcharDepth range14No_RecordsintNumber of records15AverageFishingSpeedfloat(15)MAverage fishing speed within the aggregation: year, month, c-square, vessel length category, gear code and DCF métier16FishingHourfloat(15)MFishing hour calculated from VMS data (excluding non-fishing activity)17AverageIntervalfloat(10)MAverage polling frequency calculated from VMS data18AverageVesselLengthfloat(15)MAverage vessel length within the aggregation: year,  month, c-square, gear code and DCF metier19AveragekWfloat(15)MAverage vessel power( kW) within the aggregation: year,  month, c-square, gear code and DCF metier20kWFishingHourfloat(15)MkW*Fishing hours21SweptAreafloatSwept area22TotWeightfloat(15)MTotal landings of all species caught in kg23TotValuefloat(15)Total Value of all species caught in Euro24AverageGearWidthfloat(15)MAverage Gear wid
